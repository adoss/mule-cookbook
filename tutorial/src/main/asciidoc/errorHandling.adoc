...
=== Handling Session Expiration with @ReconnectOn
...
In our Mule app, we configure a reconnection strategy and our Mule app is ready to  handle session expirations.
