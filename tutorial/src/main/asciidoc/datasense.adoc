...
image::datasense/datasense-dynamic.png[width="800"]

Note that on the XML the value written is the key.

image::datasense/datasense-dynamic-xml.png[width="800"]

After we add a DataMapper in the middle, we can see that the input and output is the one we described.

image::datasense/datasense-dynamic-datamapper.png[width="900"]
