...
+
But let's see how this affects the UI and user experience.
...
----
+
. Use a structure that we can dynamically modify, and the way to do this in Mule is by using a +Map<String,Object>+ as parameters and return types of our connector.
+
