...
----
include::{resourcesDir}/java/v7/CookBookConnector.java[lines=68..99]
----
...
<div class="panel panel-default no-padding">
    <div class="panel-heading no-padding">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li class="active"><a href="#home" role="tab" data-toggle="tab">Mule App</a></li>
            <li><a href="#profile" role="tab" data-toggle="tab">XML</a></li>
        </ul>
    </div>

    <!-- Tab panes + Panel body -->
    <div class="panel-body tab-content no-padding">
        <div class="tab-pane in active fade no-padding" id="home">
++++
image::source-example.png[width="600"]
++++
        </div>
        <div class="tab-pane fade no-padding" id="profile">
++++
